...
The calculator uses a safe custom parser (not `eval()`). For complex expressions, consider:
...
- **EVALUATION_METHODOLOGY.md**: Comprehensive evaluation methodology, scoring criteria, and metrics
- **RESOURCE_REQUIREMENTS.md**: Computational, memory, and time requirements
- **DEPLOYMENT.md**: Deployment guide and best practices
- **JUDGING_CRITERIA_COMPLIANCE.md**: Documentation of how the project meets all judging criteria
...
4. **Documentation**: Comprehensive guides covering all aspects of the project


## Resource Requirements

The GAIA Green Agent has minimal resource requirements:

- **CPU**: 1 core (2+ cores recommended)
- **Memory**: 512 MB minimum, 1 GB recommended
- **Storage**: 100 MB for code, additional space for datasets and results
- **Python**: 3.8 or higher

For detailed resource requirements, performance benchmarks, and optimization tips, see [RESOURCE_REQUIREMENTS.md](RESOURCE_REQUIREMENTS.md).

## Evaluation Methodology

The evaluation methodology provides:

- **Multi-dimensional Metrics**: Accuracy, execution quality, format quality, efficiency, and robustness
- **Nuanced Scoring**: Goes beyond binary pass/fail with weighted composite scores
- **Automated Evaluation**: Fully automated pipeline with comprehensive metrics
- **Reproducible Results**: Deterministic execution with fixed seeds

For detailed evaluation methodology, scoring criteria, and metrics, see [EVALUATION_METHODOLOGY.md](EVALUATION_METHODOLOGY.md).
